...
// import { Avatar, Button, Input, Layout, message, Modal, Space, Spin, Table, Tag, Typography } from 'antd'
...
//             <AntImage
//               key={image.asset_id}
//               src={`https://res.cloudinary.com/drtn3fqci/image/upload/${image.public_id}.${image.format}`}
//               alt={`Appointment ${currentAppointmentId} image`}
...
//       />
//       <Modal
//         title={`Hình ảnh lịch hẹn #${currentAppointmentId}`}
