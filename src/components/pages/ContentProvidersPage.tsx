...
//         <h2 className='text-2xl font-bold text-pink-600 m-0'>Danh sách nhà cung cấp</h2>
//         <Button
//           type='primary'
  ...
  return (
    <Content style={{ padding: '50px 50px' }}>
      ...
      <Modal
        ...
        okText='Thêm'
        cancelText='Hủy'
        okButtonProps={{ className: 'bg-pink-600 border-pink-600 hover:bg-pink-700 hover:border-pink-700' }}
      >
